	...
	<div class="site-wrap">
				...
				<div class="d-flex align-items-center justify-content-between">
					...
					<div class="icons">
						<a href="#" class="icons-btn d-inline-block js-search-open"><span
							...
							class="icon-shopping-bag"></span> <!--CartBag Icon's HTML is here down.... -->

							<span class="number" id="cart">2</span>
		...
		<div class="site-section">
			<div class="container">
				<div class="row mb-5">
					<div class="col-md-12">
						<div class="bg-light rounded p-3">
							<p class="mb-0">
								Returning customer? <a href="#" class="d-inline-block">Click
									here</a> to login
							</p>
						</div>
					</div>
				...
				<form method="post" action="WholesalerOrderPlaceProcess.jsp">
					<div class="row">

						<div class="col-md-6 mb-5 mb-md-0">
							<h2 class="h3 mb-3 text-black">Billing Details</h2>
							<input type="text" name="itemsJson" id="itemsJson">
								...
								<div class="form-group row">
									...
									<div class="col-md-6">
										<label for="c_postal_zip" class="text-black">Posta /
											...
											name="wo_postal_zip" required="required">
									</div>
								</div>
