...
<body>
	...
	<div class="site-wrap">
		...
		<div class="site-navbar py-2">
							...
							<ul class="site-menu js-clone-nav d-none d-lg-block">
								...
								<li class="has-children"><a href="#">Login</a>
									<ul class="dropdown">
										...
										<li><a href="#" data-toggle="modal"
											data-target="#usersLoginModal">USERs</a></li>
				...
				<div class="modal-dialog">
					<div class="modal-content">
						<div class="modal-header">
							<h5 class="modal-title" id="exampleModalLabel">Admin SignIn</h5>
						...
						<div class="modal-body">
							...
							<form action="adminLoginProcess.jsp" method="post">
								<!-- email & password passed to adminLoginProcess.jsp -->
								...
								<!-- after hitting the signIn button , the control goes to adminLoginProcess.jsp  -->

							</form>


							<!-- if admin already logged in , then he/she is directed toward it's adminHome page only no matter which page you load  -->
							<%
							...
							<%
							if (request.getAttribute("Error") != null) { // only true if and only if it has error value in it
			...
			<!-- *****************END USERs LoginModal******************* -->


			<!-- *****************START USERs LoginModal******************* -->

			<div class="modal fade" id="usersLoginModal" tabindex="-1"
				aria-labelledby="exampleModalLabel" aria-hidden="true">
				<div class="modal-dialog">
					<div class="modal-content">
						<div class="modal-header">
							<h5 class="modal-title" id="exampleModalLabel">Users SignIn</h5>
							<button type="button" class="close" data-dismiss="modal"
								aria-label="Close">
								<span aria-hidden="true">&times;</span>
							</button>
						...
						<div class="modal-body">
							...
							<!-- see whatever you fill in the form , it gets stored in the 'name' attribute whatever happens this is the fact vishwa -->
							<!-- and also when we want to access the value which we put into the form , can be accessed by using request.getParameter("whatever valueName associated in that name variable") -->
							...
							<form action="userLoginProcess.jsp" method="post">
								...
								<!-- email & password passed to USER LoginProcess.jsp -->
								...
								<div class="form-group">
									<label for="exampleInputPassword1">Password</label> <input
										...
										id="exampleInputPassword1" name="userPass"><small
										id="emailHelp" class="form-text text-muted">We'll
										never share your email with anyone else.</small>
								</div>
								<button type="submit" class="btn btn-primary">SignIn</button>
								<!-- after hitting the signIn button , the control goes to userLoginProcess.jsp  -->

							</form>


							<!-- if admin already logged in, then they are directed to their adminHome page no matter which page is loaded -->
							<%
							...
							<jsp:forward page="adminHome.jsp"></jsp:forward>
							<%
							} else if ("Manufacturer".equals(session.getAttribute("usertype"))) {
							%>
							<jsp:forward page="UserManufacturerHome.jsp"></jsp:forward>
							<%
							} else if ("Wholesaler".equals(session.getAttribute("usertype"))) {
							%>
							<jsp:forward page="UserWholesalerHome.jsp"></jsp:forward>
							<%
							} else if ("Distributor".equals(session.getAttribute("usertype"))) {
							%>
							<jsp:forward page="UserDistributorHome.jsp"></jsp:forward>
							<%
							}
							}
							else if (request.getAttribute("Error") != null){ // only true if and only if it has error value in it
								out.print("<font size='2' color='red' >");
								out.print(request.getAttribute("Error"));
								out.print("</font>");
							}
