						...
						<nav class="site-navigation text-right text-md-center"
							...
							<ul class="site-menu js-clone-nav d-none d-lg-block">
								...
								<li><a href="#" data-toggle="modal"
									data-target="#adminLoginModal">ADD USERS</a></li>
						</nav>
					</div>
					<div class="icons">
		...
		<div class="site-section bg-light">
			<div class="container">
				...
				<form action="UpdateUserProcess.jsp" method="post">
					...
					<!-- already choosen user comes from adminHome when we selected any one of them earlier-->
					
					<div class="form-group ">
						<input type="text" id="type" name="usertype"
							class="form-control" value="<%=request.getParameter("type")%>"
							readonly>
							<!-- readonly allows to read , and not to edit/update -->
					</div>

					<!-- input id -->
					<div class="form-group">
						<input type="text" id="id" name="id"
							class="form-control" value="<%=request.getParameter("id")%>"
							readonly>
					</div>
					...
					<div class="form-group">
						<input type="text" class="form-control" id="exampleInputName"
							aria-describedby="nameHelp" name="name" value="<%=request.getParameter("name")%>">
					</div>
					...
					<!-- after hitting the SAVE button , the control goes to "UpdateUserProcess.jsp"  -->
